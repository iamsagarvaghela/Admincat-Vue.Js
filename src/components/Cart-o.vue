                    ...
                    <div class="card-body pt-4 pr-4 pl-4 pb-0">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                <button class="btn btn-link px-2" @click="minusClick(item.id)">
                                ...
                                <button class="btn btn-link px-2" @click="plusClick(item.id)">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                                <router-link :to="{name:'OrderDetails', params:{orderData: JSON.stringify(getcartData)}}"  type="button" class="buy btn-block btn-lg order">
                                    PLACE ORDER
                                </router-link>
                        </div>
                    </div>
